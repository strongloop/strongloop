...
function example(argv, options, loader, type, repo, name) {
  ...
  function printDeprecated() {
    console.error();
    console.error('NOTICE'.red.inverse, 'The'.red, 
      'slc example'.yellow.underline, 
      'command only generates the example for LoopBack 1.x.'.red);
    console.error('Please use'.red, 'yo loopback:example'.yellow.underline, 
