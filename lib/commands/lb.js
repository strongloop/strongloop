module.exports = function (argv, options, loader) {
  ...
  function create(dir) {
    if(dir) {
      ...
      error('<name> is required when running `slc lb create <name>`!');
    }
  }
  ...
  function example(name) {
    name = name || 'loopback-sample-app';

    console.log('Downloading loopback-sample-app');

    exec('git clone git@github.com:strongloop/loopback-sample-app.git ' + name, function (err) {
      console.log('Installing...');
      console.log();
      exec('cd ' + name + ' && slc install', function () {
